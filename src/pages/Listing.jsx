...
export default function Listing() {
  ...
  return (
    <main>
      ...
      <div className='fixed top-[13%] right-[3%] xs:top-[17%] z-20 bg-white cursor-pointer border-2 border-gray-400 rounded-full w-10 h-10 flex justify-center items-center' onClick={() => {
